...
import com.babelsoftware.loudly.db.entities.ArtistEntity
import com.babelsoftware.loudly.db.entities.PlaylistEntity
import com.babelsoftware.loudly.db.entities.PlaylistSongMap
import com.babelsoftware.loudly.db.entities.SongArtistMap
import com.babelsoftware.loudly.db.entities.SongEntity
import com.babelsoftware.loudly.models.SpotifyAuthResponse
import com.babelsoftware.loudly.models.SpotifyUserProfile
import com.babelsoftware.loudly.models.spotify.playlists.SpotifyPlaylistPaginatedResponse
import com.babelsoftware.loudly.models.spotify.tracks.SpotifyResultPaginatedResponse
import com.babelsoftware.loudly.models.spotify.tracks.TrackItem
import com.babelsoftware.loudly.ui.screens.settings.import_from_spotify.model.ImportFromSpotifyScreenState
import com.babelsoftware.loudly.ui.screens.settings.import_from_spotify.model.ImportProgressEvent
import com.babelsoftware.loudly.ui.screens.settings.import_from_spotify.model.Playlist
...
class ImportFromSpotifyViewModel @Inject constructor(
    ...
    private fun logTheString(string: String) {
        Timber.tag("Loudly Log").d(string)
    }
    ...
    private suspend fun importPlaylists(
        ...
        selectedPlaylists.forEachIndexed { playlistIndex, playlist ->
            ...
            val generatedPlaylistId = PlaylistEntity.Companion.generatePlaylistId()
