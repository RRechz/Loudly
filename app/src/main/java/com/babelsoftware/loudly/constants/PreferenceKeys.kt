package com.babelsoftware.loudly.constants
...
val LyricFontSizeKey = intPreferencesKey("lyrics_font_size")
val LyricsBackgroundDimKey = intPreferencesKey("lyrics_background_dim")
...
val HeaderImageKey = stringPreferencesKey("header_image_key")
