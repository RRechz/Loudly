package com.babelsoftware.loudly.db
...
import com.babelsoftware.loudly.constants.AlbumSortType
import com.babelsoftware.loudly.constants.ArtistSongSortType
import com.babelsoftware.loudly.constants.ArtistSortType
import com.babelsoftware.loudly.constants.PlaylistSortType
import com.babelsoftware.loudly.constants.SongSortType
import com.babelsoftware.loudly.db.entities.Album
import com.babelsoftware.loudly.db.entities.AlbumArtistMap
import com.babelsoftware.loudly.db.entities.AlbumEntity
...
import com.babelsoftware.loudly.db.entities.RecentActivityEntity
...
import com.babelsoftware.loudly.extensions.reversed
import com.babelsoftware.loudly.extensions.toSQLiteQuery
import com.babelsoftware.loudly.models.MediaMetadata
import com.babelsoftware.loudly.models.toMediaMetadata
import com.babelsoftware.loudly.ui.utils.resize
...
interface DatabaseDao {
    ...
    fun insert(mediaMetadata: MediaMetadata, block: (SongEntity) -> SongEntity = { it }) {
        ...
        mediaMetadata.artists.forEachIndexed { index, artist ->
            val artistId = artist.id ?: artistByName(artist.name)?.id ?: ArtistEntity.Companion.generateArtistId()
            insert(
                ArtistEntity(
                    id = artistId,
                    name = artist.name
        ...
        albumPage.album.artists
            ?.map { artist ->
                ArtistEntity(
                    ...
                    ?: ArtistEntity.Companion.generateArtistId(),
                    name = artist.name
                )
            }
            ?.onEach(::insert)
