...
import com.babelsoftware.loudly.constants.fullScreenLyricsKey
...
import com.babelsoftware.loudly.ui.menu.LyricsMenu
import com.babelsoftware.loudly.ui.screens.settings.DarkMode
import com.babelsoftware.loudly.ui.screens.settings.LyricsPosition
...
fun Lyrics(
    ...
    val lines = remember(lyrics) {
        if (lyrics == null || lyrics == LyricsEntity.Companion.LYRICS_NOT_FOUND) emptyList()
        else if (lyrics.startsWith("[")) listOf(LyricsEntry.Companion.HEAD_LYRICS_ENTRY) +
                LyricsUtils.parseLyrics(lyrics, lyricTrim.value, multilineLrc.value)
    ...
    LaunchedEffect(lyrics) {
        ...
        while (isActive) {
            ...
            currentLineIndex = LyricsUtils.findCurrentLineIndex(
                lines,
    ...
    BoxWithConstraints(
        ...
        if (lyrics == LyricsEntity.Companion.LYRICS_NOT_FOUND) {
            Text(
