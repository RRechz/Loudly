...
import com.babelsoftware.innertube.models.body.CreatePlaylistBody
...
import com.babelsoftware.innertube.utils.sha1
...
class InnerTube {
    ...
    private fun createClient() = HttpClient(OkHttp) {
        ...
        defaultRequest {
            url(YouTubeClient.Companion.API_URL_YOUTUBE_MUSIC)
        }
    }
        ...
        setBody(
            PlayerBody(
                context = client.toContext(locale, visitorData).let {
                    if (client == YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER) {
                        it.copy(
